...
### 📌 팝업 고정
기본은 다른 곳을 클릭하면(포커스를 잃으면) 자동으로 닫히고, 고정 버튼 하나로 계속 띄워둘 수 있습니다.
...
<sub>사용량 팝업 — 작업표시줄/트레이 아이콘 근처에 뜨고, 📌로 고정하지 않으면 다른 곳을 클릭할 때 자동으로 닫힙니다</sub>
</td>
<td align="center" width="50%">
...
| 동작 | 결과 |
| --- | --- |
| 좌클릭 | 세션/주간 사용량 %와 리셋 시간 팝업 (작업표시줄/트레이 아이콘 근처에 뜨고, 다른 곳을 클릭하면 자동으로 닫힘) |
