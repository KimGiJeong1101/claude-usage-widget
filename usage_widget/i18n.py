...
_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "ko": {
        ...
        "update.error_not_supported": "이 빌드/플랫폼에서는 자동 업데이트를 지원하지 않습니다",
        "update.error_no_exe_in_zip": "릴리즈 zip 안에 실행 파일이 없습니다",
    ...
    "en": {
        ...
        "update.error_not_supported": "Automatic updates aren't supported on this build/platform",
        "update.error_no_exe_in_zip": "No executable found inside the release zip",
    ...
    "ja": {
        ...
        "update.error_not_supported": "このビルド・プラットフォームでは自動アップデートに対応していません",
        "update.error_no_exe_in_zip": "リリースのzipに実行ファイルが見つかりません",
    ...
    "zh-CN": {
        ...
        "update.error_not_supported": "此构建版本/平台不支持自动更新",
        "update.error_no_exe_in_zip": "发布的 zip 中找不到可执行文件",
